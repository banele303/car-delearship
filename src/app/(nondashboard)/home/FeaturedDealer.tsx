            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-start mb-3">
                  <MapPin size={18} className="text-[#00acee] mr-3 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-center mb-3">
                  <Phone size={18} className="text-[#00acee] mr-3 flex-shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">
                    {dealer.phone}
                  </span>
                </div>
                ...
                <div className="flex items-center mb-3">
                  <Mail size={18} className="text-[#00acee] mr-3 flex-shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">
                    {dealer.email}
                  </span>
                </div>
                ...
                <div className="flex items-start mb-4">
                  <Clock size={18} className="text-[#00acee] mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">
                    {dealer.hours}
                  </span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {dealer.specialties.map((specialty, idx) => (
                      <span
                        key={idx}
                        className="bg-blue-100 dark:bg-blue-900 text-[#00acee] dark:text-blue-300 px-2 py-1 rounded-md text-xs"
                      >
                        {specialty}
                      </span>
                    ))}
