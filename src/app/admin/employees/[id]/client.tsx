...
export default function EmployeeDetailsClient({ id }: EmployeeDetailsProps) { 
  ...
  const employeeData = {
    ...
    managedCars: (employee as any)?.managedCars || [], 
    customers: (employee as any)?.customers || [], 
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div>
            <div className={cn(
              ...
              employeeData.status === "ACTIVE" ? "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400" : 
              employeeData.status === "INACTIVE" ? "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400" : 
              employeeData.status === "SUSPENDED" ? "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400" : 
