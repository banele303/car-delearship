            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                <p className="text-green-600 font-bold">
                  R {reservationFee.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="agreeToTerms" className="text-sm leading-5">
                  I agree to the terms and conditions, including the R{reservationFee.toLocaleString()} reservation fee. 
                  This fee is refundable if the purchase is not completed due to financing issues or vehicle defects. *
                </Label>
              </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="text-sm text-blue-800">
                <strong>Important:</strong> By submitting this reservation, you commit to purchasing this vehicle. 
                The reservation fee secures the vehicle for 7 days. Final paperwork and payment must be completed 
                within this period to avoid forfeiture of the reservation fee.
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            >
              ...
              {isSubmitting ? "Processing..." : `Reserve for R${reservationFee.toLocaleString()}`}
            </Button>
          </div>
        </form>
      </DialogContent>
