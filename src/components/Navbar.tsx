        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" onClick={() => router.push("/customers/dashboard")}>Dashboard</Button>
      ...
      >
        <div className="px-4 pt-2 pb-6 space-y-2">
          ...
          <div className="pt-2 flex flex-col gap-2 border-t border-slate-200 dark:border-slate-700 mt-2">
            ...
            {user ? (
              <>
                <Button variant="outline" className="justify-start" onClick={() => router.push("/customers/dashboard")}>Dashboard</Button>
