        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold">ADVANCE AUTO </span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/contact-us" className="text-gray-400 hover:text-[#00acee] transition-colors">
                  Contact
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+27680720424" className="text-gray-400 hover:text-[#00acee] transition-colors">
                  068 072 0424
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-[#00acee]" />
                <a href="mailto:info@advancedautotrader.co.za" className="text-gray-400 hover:text-[#00A211] transition-colors">
                  info@advancedautotrader.co.za
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="h-4 w-4 text-[#00acee]" />
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <div className="mb-2 md:mb-0">
              <p>&copy; 2025 Advance Auto. All rights reserved.</p>
            </div>
