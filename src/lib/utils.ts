...
export const createNewUserInDatabase = async (
  ...
  const createEndpoint =
    userRole?.toLowerCase() === "employee" ? "/employees" : "/customers";
  ...
  const userData = {
    ...
    phoneNumber: '',
    // For employees, include required fields from the Employee model
    ...(userRole?.toLowerCase() === "employee" && {
      role: 'SALES_ASSOCIATE', // Default role for new employees
      status: 'ACTIVE',
